...
public class BodyShapeEditor extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!AdManager.isloadMAX) {
            ...
            //MAX + Fb Ads
            AdManager.initMAX(BodyShapeEditor.this);
            AdManager.maxInterstital(BodyShapeEditor.this);
        }
    }
    ...
    void startActivityes(Intent intent, int requestCode) {
        if (!AdManager.isloadMAX) {
            ...
            AdManager.adCounter++;
            AdManager.showMaxInterstitial(BodyShapeEditor.this, intent, requestCode);
        }
    }
