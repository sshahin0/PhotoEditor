...
import com.limsphere.pe.adapter.ScrapBGAdapter;
import com.limsphere.pe.adapter.ScrapStickerAdapter;
import com.limsphere.pe.utils.Utils;
import com.limsphere.pe.appconfig.Logger;
import com.limsphere.pe.appconfig.AppConstant;
import com.limsphere.pe.listener.OnChooseColorListener;
...
import com.limsphere.pe.utils.DialogUtils;
import com.limsphere.pe.utils.ImageUtils;
import com.limsphere.pe.utils.PhotoUtils;
...
//        //by clicking the area outside the dialog.
    ...
    void startActivityes(Intent intent, int requestCode) {
        if (!AdManager.isloadMAX) {
            ...
            AdManager.adCounter++;
            AdManager.showMaxInterstitial(getActivity(), intent, requestCode);
        }
    }
    ...
    public void setBackground(String name) {
        ...
        try {
            ...
            File path = new File(Environment.getExternalStorageDirectory() + "/Download/backgrounds_image");
            if (!path.isDirectory()) {
                path.mkdirs();
            }
            File mypath = new File(path.getAbsolutePath(), name);
